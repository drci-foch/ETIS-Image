...
$itemDirs = Get-ChildItem -Path $rootDir -Directory | Where-Object { $_.Name -ne "CLOT_SEG" -and $_.Name -ne "T2star_" -and $_.Name -ne "T2star_GRE" -and $_.Name -ne "T2star_SWI" -and $_.Name -ne "T2star_SWAN" -and $_.Name -ne "TOF3D" }
